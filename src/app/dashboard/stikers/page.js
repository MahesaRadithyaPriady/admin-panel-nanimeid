        ...
        <div className="lg:sticky lg:top-4">
          <form onSubmit={onSubmit} className="card p-4 space-y-3">
            <div className="text-sm font-extrabold border-b-2 border-[var(--border)] pb-2 mb-1">
              {mode === 'add' ? '+ Tambah Stiker Baru' : '✎ Edit Stiker'}
            </div>
            ...
            <div className="grid gap-1">
              ...
              {(form.previewUrl || (form.image_mode === 'url' ? form.image_url : form.existingImageUrl)) && (
                <div className="flex items-center gap-2 text-xs mt-1">
                  ...
                  <img src={form.previewUrl || (form.image_mode === 'url' ? form.image_url : form.existingImageUrl)} alt="preview" className="w-12 h-12 object-contain border-2 border-[var(--border)]" loading="lazy" decoding="async" />
                </div>
              )}
            </div>
