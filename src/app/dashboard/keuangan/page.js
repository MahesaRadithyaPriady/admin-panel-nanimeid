  ...
  if (!allowed.includes(user.role)) {
    return (
      <div className="text-sm font-semibold">
        Halaman ini untuk role <span className="px-2 py-1 border-2 border-[var(--border)] rounded bg-[#F2F2F2]">superadmin</span> atau <span className="px-2 py-1 border-2 border-[var(--border)] rounded bg-[#F2F2F2]">keuangan</span>.
      </div>
    );
  }
